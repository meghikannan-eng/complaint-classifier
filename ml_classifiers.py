  ...
  "cells": [
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "NW85C7I9QIX1",
        "outputId": "43d4bfbc-2954-48e5-87a9-161bbcd4eef8"
      },
      "outputs": [
        {
          "output_type": "stream",
        ...
        },
        {
          ...
          "data": {
            ...
            "image/png": "\n"
          },
          "metadata": {}
        },
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "qJwEx28uTlgK",
        "outputId": "5cddc9cd-4110-4080-c749-ef457fb6cc23"
      },
      "execution_count": 3,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "S41FJBD0Toi2",
        "outputId": "bda6804c-bd7e-41ae-dfc2-6517174588a1"
      },
      "execution_count": 4,
      "outputs": [
        {
          ...
          "text": [
            ...
            "5                                  staff polite asap      0  \n",
            "6                urgent money deduct order fail asap      2  \n",
            "7    immediate help need account lock balance inside      2  \n",
            "8              unauthorized payment card please help      2  \n",
            "9                        staff polite kindly resolve      0  \n",
            "\n",
            "Avg tokens per class:\n",
            "label\n",
            "0    4.224895\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "u9s7bX3SUL4p",
        "outputId": "513da94e-3859-4bff-a3f4-d4ebb0573858"
      },
      "execution_count": 5,
      "outputs": [
        {
          ...
          "text": [
            ...
            "6             My subscription renewal failed but I am still logged in.                 subscription renewal fail still log   Medium\n",
            "7          Network is slow during peak hours, affecting my work daily.            network slow peak hour affect work daily   Medium\n",
            "8          Cannot login to my account since yesterday, please help me.   can not login account since yesterday please help   Medium\n",
            "9            Order arrived damaged, need replacement or refund please.  order arrive damage need replacement refund please   Medium\n",
            "10              App UI could be better. Would love a dark mode option.       app ui could well would love dark mode option      Low\n",
            "11           Just a suggestion — add more payment methods to checkout.              suggestion add payment method checkout      Low\n",
            "12              The font size in settings is a bit small, minor issue.             font size setting bit small minor issue      Low\n",
            "13          Would be nice to have a search filter in the product page.               would nice search filter product page      Low\n",
            "14            Dashboard layout is okay but could use some improvement.         dashboard layout okay could use improvement      Low\n",
            "\n",
            ...
            "============================================================\n",
            "Vocabulary size      : 136\n",
            "X_train_bow shape    : (12, 136)  (docs × features)\n",
            "X_test_bow shape     : (3, 136)\n",
            "Matrix is sparse     : 8.8% non-zero\n",
            "\n",
            ...
            "============================================================\n",
            "Vocabulary size      : 136\n",
            "X_train_tfidf shape  : (12, 136)  (docs × features)\n",
            "X_test_tfidf shape   : (3, 136)\n",
            "\n",
            "Top 10 TF-IDF features (by mean score):\n",
            "  account                   mean_tfidf=0.0567\n",
            "  please                    mean_tfidf=0.0533\n",
            "  transaction               mean_tfidf=0.0411\n",
            "  card                      mean_tfidf=0.0411\n",
            "  help                      mean_tfidf=0.0397\n",
            "  could                     mean_tfidf=0.0393\n",
            "  twice                     mean_tfidf=0.0285\n",
            "  twice fix                 mean_tfidf=0.0285\n",
            "  fix immediately           mean_tfidf=0.0285\n",
            "  fix                       mean_tfidf=0.0285\n",
            "\n",
            "============================================================\n",
            "TOP TF-IDF WORDS PER PRIORITY CLASS\n",
            "============================================================\n",
            "  High   : account(0.138), transaction(0.100), card(0.100), please(0.081), payment process(0.070)\n",
            "  Medium : please(0.078), subscription renewal(0.067), still log(0.067), still(0.067), delivery day(0.067)\n",
            "  Low    : would(0.096), could(0.096), suggestion(0.068), suggestion add(0.068), method(0.068)\n",
            "\n",
            ...
            "\n",
            "Saved → tfidf_top_words_per_class.png\n",
            "Saved → bow_vs_tfidf_heatmap.png\n",
            "Saved → bow_vs_tfidf_comparison.png\n",
            "\n",
            "============================================================\n",
            "FEATURE EXTRACTION COMPLETE\n",
            "============================================================\n",
            "Pass these to your models in Part 4:\n",
            "  ML (BoW)   : X_train_bow,   X_test_bow,   y_train, y_test\n",
            "  ML (TF-IDF): X_train_tfidf, X_test_tfidf, y_train, y_test\n",
            "\n",
            "Load saved matrices:\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "wrSLkdBCWICm",
        "outputId": "6326dd1f-5eb0-4c53-f84a-d20d383faa94"
      },
      "execution_count": 6,
      "outputs": [
        {
          ...
          "text": [
            ...
            "          could    0.017377     6               0.141127\n",
            "        setting    0.017044     7               0.158171\n",
            "         detect    0.016269     8               0.174440\n",
            "            app    0.014286     9               0.188725\n",
            "           well    0.013449    10               0.202174\n",
            "          minor    0.013386    11               0.215559\n",
            "            bit    0.011836    12               0.227396\n",
            "        service    0.011799    13               0.239194\n",
            "        payment    0.011438    14               0.250632\n",
            "           need    0.010879    15               0.261511\n",
            "       checkout    0.010791    16               0.272302\n",
            "          block    0.010442    17               0.282743\n",
            "fix immediately    0.010088    18               0.292831\n",
            "            fix    0.010060    19               0.302891\n",
            "           help    0.009588    20               0.312479\n",
            "\n",
            "Computing permutation importance (more reliable)…\n",
            "\n",
            "Top 20 features by Permutation Importance:\n",
            "             feature  perm_importance  perm_std\n",
            "             account            0.325  0.225000\n",
            "               could            0.300  0.217945\n",
            "               would            0.275  0.207666\n",
            "        unauthorized            0.175  0.114564\n",
            "             payment            0.100  0.122474\n",
            "      account charge            0.000  0.000000\n",
            "account unauthorized            0.000  0.000000\n",
            "                 add            0.000  0.000000\n",
            "        account hack            0.000  0.000000\n",
            "       account since            0.000  0.000000\n",
            "              access            0.000  0.000000\n",
            "                 app            0.000  0.000000\n",
            "           app could            0.000  0.000000\n",
            "          appreciate            0.000  0.000000\n",
            "              app ui            0.000  0.000000\n",
            "              arrive            0.000  0.000000\n",
            "       arrive damage            0.000  0.000000\n",
            "                 bit            0.000  0.000000\n",
            "     appreciate well            0.000  0.000000\n",
            "           bit small            0.000  0.000000\n",
            "\n",
            "Strategy A — Top 50 features (fixed):\n",
            "['account', 'would', 'please', 'card', 'transaction', 'could', 'setting', 'detect', 'app', 'well'] … (and more)\n",
            "\n",
            "Strategy B — Features covering 80% cumulative importance:\n",
            "  → 102 features selected\n",
            "['account', 'would', 'please', 'card', 'transaction', 'could', 'setting', 'detect', 'app', 'well'] … (and more)\n",
            "\n",
            "Reduced matrix shape  : (16, 50)\n",
            "Original matrix shape : (16, 171)\n",
            "Features removed      : 121\n",
            "\n",
            "Saved → X_train_reduced.npz, X_test_reduced.npz, top_feature_names.npy\n",
            "\n",
            "============================================================\n",
            "PER-CLASS FEATURE IMPORTANCE\n",
            "============================================================\n",
            "  Low     → top 5: ['would', 'bit', 'minor', 'setting', 'please']\n",
            "  Medium  → top 5: ['late', 'day', 'renewal', 'gateway', 'subscription']\n",
            "  High    → top 5: ['account', 'transaction', 'detect', 'fix immediately', 'twice fix']\n",
            "\n",
            "Saved → rf_top20_mdi_importance.png\n",
            "Saved → rf_permutation_importance.png\n",
            "Saved → rf_cumulative_importance.png\n",
            "Saved → rf_per_class_importance.png\n",
            "Saved → rf_importance_heatmap.png\n",
            "\n",
            "============================================================\n",
            "FEATURE IMPORTANCE RANKING COMPLETE\n",
            "============================================================\n",
            "Total features in TF-IDF vocabulary : 171\n",
            "Top-50 selected (fixed strategy)       : 50\n",
            "Features at 80% cumulative threshold : 102\n",
            "\n",
            "Files ready for Part 4 (model building):\n",
            "  X_train_reduced.npz  — reduced feature matrix (train)\n",
            "  X_test_reduced.npz   — reduced feature matrix (test)\n",
            "  top_feature_names.npy — names of selected features\n",
            "\n",
            "Tip: use X_train_reduced instead of X_train_tfidf\n",
            "     to train faster models with less noise.\n"
          ]
        }
      ]
    },
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "eEUqS5_7ZDE2",
        "outputId": "85b069b6-9c96-4477-85f8-ed896632f885"
      },
      "execution_count": 7,
      "outputs": [
        {
          ...
          "text": [
            ...
            "Logistic Regression   1.0000    1.0000  1.0000   1.0000  1.0000     0.5701  +/-0.1354\n",
            "SVM                   1.0000    1.0000  1.0000   1.0000  0.0833     0.5040  +/-0.2259\n",
            "XGBoost               0.5000    0.3333  0.5000   0.4000  0.8333     0.4471  +/-0.0262\n",
            "RandomForest          0.5000    0.4667  0.5000   0.4127  1.0000     0.3127  +/-0.1473\n",
            "\n",
            "Best model by weighted F1: Logistic Regression (1.0000)\n",
            "\n",
            "Saved outputs:\n",
            "  model_comparison.png    — grouped bar chart, all metrics\n",
            "  confusion_matrices.png  — 2x2 grid, count + normalised %\n",
            "  roc_curves.png          — one-vs-rest per class, all models\n",
            "  cv_f1_comparison.png    — cross-validation stability boxplot\n",
            "  per_class_f1_heatmap.png — F1 per class × model heatmap\n",
            "\n",
            "Next step → Part 5: LSTM with word embeddings\n"
          ]
        }
      ]
    },
    {
      ...
      "metadata": {
        ...
        "id": "Bsok6lJ0lEia",
        "outputId": "5f1a9453-7378-4507-e7d5-a7443e8c7918"
      },
      "execution_count": 13,
      "outputs": [
        {
        ...
        },
        {
          ...
          "name": "stderr",
          "text": [
            "WARNING:tensorflow:5 out of the last 7 calls to <function TensorFlowTrainer.make_predict_function.<locals>.one_step_on_data_distributed at 0x7ce1ba52d080> triggered tf.function retracing. Tracing is expensive and the excessive number of tracings could be due to (1) creating @tf.function repeatedly in a loop, (2) passing tensors with different shapes, (3) passing Python objects instead of tensors. For (1), please define your @tf.function outside of the loop. For (2), @tf.function has reduce_retracing=True option that can avoid unnecessary retracing. For (3), please refer to https://www.tensorflow.org/guide/function#controlling_retracing and https://www.tensorflow.org/api_docs/python/tf/function for  more details.\n"
          ]
        },
        {
          "output_type": "stream",
        ...
        },
        {
          ...
          "name": "stderr",
          "text": [
            "WARNING:tensorflow:6 out of the last 8 calls to <function TensorFlowTrainer.make_predict_function.<locals>.one_step_on_data_distributed at 0x7ce1b776bb00> triggered tf.function retracing. Tracing is expensive and the excessive number of tracings could be due to (1) creating @tf.function repeatedly in a loop, (2) passing tensors with different shapes, (3) passing Python objects instead of tensors. For (1), please define your @tf.function outside of the loop. For (2), @tf.function has reduce_retracing=True option that can avoid unnecessary retracing. For (3), please refer to https://www.tensorflow.org/guide/function#controlling_retracing and https://www.tensorflow.org/api_docs/python/tf/function for  more details.\n"
          ]
        },
        {
          "output_type": "stream",
          ...
          "text": [
            ...
            "weighted avg       0.11      0.33      0.17         6\n",
            "\n",
            "Best strategy  : Random Embeddings  (F1=0.1667)\n",
            "Saved → lstm_w2v_best.keras\n",
            "Saved → w2v_training_curves.png\n",
            "Saved → w2v_metric_comparison.png\n",
            "Saved → w2v_confusion_matrices.png\n",
            "Saved → w2v_embedding_heatmap.png\n",
            "Saved → w2v_semantic_space.png\n",
            "\n",
            "Demo predictions:\n",
            "  [Low   ] (0.37) → My card was used for unauthorized transactions!\n",
            "  [Low   ] (0.37) → Refund not received after 5 days.\n",
            "  [Low   ] (0.38) → Would love a dark mode option in the app.\n",
            "\n",
            "============================================================\n",
            "WORD2VEC + LSTM COMPLETE\n",
            "============================================================\n",
            "Best strategy    : Random Embeddings  (F1=0.1667)\n",
            "\n",
            "Embedding strategy guide:\n",
            "  Random     → use when dataset is large (>5000 samples)\n",
            "  W2V Frozen → use when dataset is very small (<500 samples)\n",
            "  W2V Fine-  → best general choice for moderate datasets\n",
            "  tuned         (500–5000 samples)\n",
            "\n",
            "To use GloVe instead of Word2Vec:\n",
            "  1. Download glove.6B.zip from nlp.stanford.edu/projects/glove\n",
            "  2. Call load_glove_embeddings() defined in Section 5\n",
            "  3. Pass the result as embedding_weights= in build_lstm()\n",
            "\n",
            "Saved files:\n",
            "  lstm_w2v_best.keras        — best trained model\n",
            "  word2vec_vectors.txt       — W2V word vectors\n",
            "  w2v_embedding_matrix.npy   — embedding weight matrix\n",
            "  w2v_training_curves.png\n",
            "  w2v_metric_comparison.png\n",
            "  w2v_confusion_matrices.png\n",
            "  w2v_embedding_heatmap.png\n",
            "  w2v_semantic_space.png\n"
          ]
        }
      ]
    },
    {
      ...
      "metadata": {
        ...
        "id": "XK_d6uN8pkI2",
        "outputId": "4516bec8-b47e-4ddd-d94b-7d0117964554"
      },
      "execution_count": 14,
      "outputs": [
        {
        ...
        },
        {
          ...
          "data": {
            ...
            "text/html": [
              ...
              "├─────────────────────────────────┼────────────────────────┼───────────────┤\n",
              "│ spatial_dropout                 │ ?                      │             <span style=\"color: #00af00; text-decoration-color: #00af00\">0</span> │\n",
              ...
              "├─────────────────────────────────┼────────────────────────┼───────────────┤\n",
              "│ global_max_pool                 │ ?                      │             <span style=\"color: #00af00; text-decoration-color: #00af00\">0</span> │\n",
        ...
        },
        {
          ...
          "text": [
            ...
            "Training LSTM model …\n",
            "Epoch 1/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m7s\u001b[0m 1s/step - accuracy: 0.3125 - loss: 1.0995 - val_accuracy: 0.5000 - val_loss: 1.0950 - learning_rate: 0.0010\n",
            "Epoch 2/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m1s\u001b[0m 202ms/step - accuracy: 0.1875 - loss: 1.1034 - val_accuracy: 0.5000 - val_loss: 1.0927 - learning_rate: 0.0010\n",
            "Epoch 3/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m1s\u001b[0m 122ms/step - accuracy: 0.4375 - loss: 1.0913 - val_accuracy: 0.5000 - val_loss: 1.0913 - learning_rate: 0.0010\n",
            "Epoch 4/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 116ms/step - accuracy: 0.3125 - loss: 1.0933 - val_accuracy: 0.5000 - val_loss: 1.0905 - learning_rate: 0.0010\n",
            "Epoch 5/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 116ms/step - accuracy: 0.3125 - loss: 1.0920 - val_accuracy: 0.5000 - val_loss: 1.0892 - learning_rate: 0.0010\n",
            "Epoch 6/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 118ms/step - accuracy: 0.3750 - loss: 1.0862 - val_accuracy: 0.5000 - val_loss: 1.0873 - learning_rate: 0.0010\n",
            "Epoch 7/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 121ms/step - accuracy: 0.3750 - loss: 1.0811 - val_accuracy: 0.5000 - val_loss: 1.0850 - learning_rate: 0.0010\n",
            "Epoch 8/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 119ms/step - accuracy: 0.3125 - loss: 1.1009 - val_accuracy: 0.5000 - val_loss: 1.0829 - learning_rate: 0.0010\n",
            "Epoch 9/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 115ms/step - accuracy: 0.3750 - loss: 1.0954 - val_accuracy: 0.5000 - val_loss: 1.0814 - learning_rate: 0.0010\n",
            "Epoch 10/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 118ms/step - accuracy: 0.3750 - loss: 1.0944 - val_accuracy: 0.5000 - val_loss: 1.0806 - learning_rate: 0.0010\n",
            "Epoch 11/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 118ms/step - accuracy: 0.3750 - loss: 1.0883 - val_accuracy: 0.5000 - val_loss: 1.0811 - learning_rate: 0.0010\n",
            "Epoch 12/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 117ms/step - accuracy: 0.3750 - loss: 1.0815 - val_accuracy: 0.5000 - val_loss: 1.0801 - learning_rate: 0.0010\n",
            "Epoch 13/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 157ms/step - accuracy: 0.3750 - loss: 1.0922 - val_accuracy: 0.5000 - val_loss: 1.0798 - learning_rate: 0.0010\n",
            "Epoch 14/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 126ms/step - accuracy: 0.4375 - loss: 1.0685 - val_accuracy: 0.5000 - val_loss: 1.0797 - learning_rate: 0.0010\n",
            "Epoch 15/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 119ms/step - accuracy: 0.3750 - loss: 1.0661 - val_accuracy: 0.5000 - val_loss: 1.0796 - learning_rate: 0.0010\n",
            "Epoch 16/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 118ms/step - accuracy: 0.4375 - loss: 1.0815 - val_accuracy: 0.5000 - val_loss: 1.0794 - learning_rate: 0.0010\n",
            "Epoch 17/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 119ms/step - accuracy: 0.3750 - loss: 1.0638 - val_accuracy: 0.5000 - val_loss: 1.0780 - learning_rate: 0.0010\n",
            "Epoch 18/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 118ms/step - accuracy: 0.4375 - loss: 1.0614 - val_accuracy: 0.5000 - val_loss: 1.0768 - learning_rate: 0.0010\n",
            "Epoch 19/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 117ms/step - accuracy: 0.3750 - loss: 1.0558 - val_accuracy: 0.5000 - val_loss: 1.0754 - learning_rate: 0.0010\n",
            "Epoch 20/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 118ms/step - accuracy: 0.5000 - loss: 1.0546 - val_accuracy: 0.5000 - val_loss: 1.0740 - learning_rate: 0.0010\n",
            "Epoch 21/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 119ms/step - accuracy: 0.4375 - loss: 1.0484 - val_accuracy: 0.5000 - val_loss: 1.0715 - learning_rate: 0.0010\n",
            "Epoch 22/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 122ms/step - accuracy: 0.4375 - loss: 1.0317 - val_accuracy: 0.5000 - val_loss: 1.0675 - learning_rate: 0.0010\n",
            "Epoch 23/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 131ms/step - accuracy: 0.4375 - loss: 1.0297 - val_accuracy: 0.5000 - val_loss: 1.0637 - learning_rate: 0.0010\n",
            "Epoch 24/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 146ms/step - accuracy: 0.5000 - loss: 1.0225 - val_accuracy: 0.5000 - val_loss: 1.0606 - learning_rate: 0.0010\n",
            "Epoch 25/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 117ms/step - accuracy: 0.4375 - loss: 1.0086 - val_accuracy: 0.5000 - val_loss: 1.0586 - learning_rate: 0.0010\n",
            "Epoch 26/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 116ms/step - accuracy: 0.8125 - loss: 0.9677 - val_accuracy: 0.5000 - val_loss: 1.0543 - learning_rate: 0.0010\n",
            "Epoch 27/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 201ms/step - accuracy: 0.6250 - loss: 0.9628 - val_accuracy: 0.5000 - val_loss: 1.0489 - learning_rate: 0.0010\n",
            "Epoch 28/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 125ms/step - accuracy: 0.6250 - loss: 0.9305 - val_accuracy: 0.5000 - val_loss: 1.0424 - learning_rate: 0.0010\n",
            "Epoch 29/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 133ms/step - accuracy: 0.8125 - loss: 0.9200 - val_accuracy: 0.5000 - val_loss: 1.0363 - learning_rate: 0.0010\n",
            "Epoch 30/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 116ms/step - accuracy: 0.8750 - loss: 0.8814 - val_accuracy: 0.7500 - val_loss: 1.0284 - learning_rate: 0.0010\n",
            "Epoch 31/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 118ms/step - accuracy: 0.8750 - loss: 0.8554 - val_accuracy: 0.5000 - val_loss: 1.0200 - learning_rate: 0.0010\n",
            "Epoch 32/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 119ms/step - accuracy: 0.8750 - loss: 0.8108 - val_accuracy: 0.5000 - val_loss: 1.0125 - learning_rate: 0.0010\n",
            "Epoch 33/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 155ms/step - accuracy: 0.9375 - loss: 0.7177 - val_accuracy: 0.5000 - val_loss: 1.0044 - learning_rate: 0.0010\n",
            "Epoch 34/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 123ms/step - accuracy: 1.0000 - loss: 0.6797 - val_accuracy: 0.5000 - val_loss: 0.9987 - learning_rate: 0.0010\n",
            "Epoch 35/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 120ms/step - accuracy: 0.9375 - loss: 0.6632 - val_accuracy: 0.5000 - val_loss: 0.9969 - learning_rate: 0.0010\n",
            "Epoch 36/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 120ms/step - accuracy: 0.9375 - loss: 0.5631 - val_accuracy: 0.5000 - val_loss: 1.0052 - learning_rate: 0.0010\n",
            "Epoch 37/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 119ms/step - accuracy: 0.9375 - loss: 0.5228 - val_accuracy: 0.5000 - val_loss: 1.0324 - learning_rate: 0.0010\n",
            "Epoch 38/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 126ms/step - accuracy: 0.9375 - loss: 0.3887 - val_accuracy: 0.5000 - val_loss: 1.0867 - learning_rate: 0.0010\n",
            "Epoch 39/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 118ms/step - accuracy: 0.9375 - loss: 0.3193 - val_accuracy: 0.5000 - val_loss: 1.1892 - learning_rate: 0.0010\n",
            "Epoch 40/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 123ms/step - accuracy: 0.8125 - loss: 0.4148 - val_accuracy: 0.5000 - val_loss: 1.2832 - learning_rate: 0.0010\n",
            "Epoch 41/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 118ms/step - accuracy: 0.7500 - loss: 0.3615 - val_accuracy: 0.5000 - val_loss: 1.0749 - learning_rate: 5.0000e-04\n",
            "Epoch 42/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 125ms/step - accuracy: 0.9375 - loss: 0.2572 - val_accuracy: 0.5000 - val_loss: 1.0427 - learning_rate: 5.0000e-04\n",
            "Epoch 43/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 123ms/step - accuracy: 0.9375 - loss: 0.3325 - val_accuracy: 0.5000 - val_loss: 1.0311 - learning_rate: 5.0000e-04\n",
            "Epoch 44/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 119ms/step - accuracy: 1.0000 - loss: 0.2355 - val_accuracy: 0.5000 - val_loss: 1.0351 - learning_rate: 5.0000e-04\n",
            "Epoch 45/60\n",
            "\u001b[1m2/2\u001b[0m \u001b[32m━━━━━━━━━━━━━━━━━━━━\u001b[0m\u001b[37m\u001b[0m \u001b[1m0s\u001b[0m 143ms/step - accuracy: 0.9375 - loss: 0.4869 - val_accuracy: 0.5000 - val_loss: 1.0688 - learning_rate: 5.0000e-04\n",
            "Epoch 45: early stopping\n",
            "Restoring model weights from the end of the best epoch: 35.\n",
            "\n",
            "Training stopped at epoch 45\n",
            "Best val_loss: 0.9969 | Best val_accuracy: 0.7500\n",
            "\n",
            "============================================================\n",
            ...
            "weighted avg       1.00      1.00      1.00         6\n",
            "\n",
            "Saved: lstm_complaint_classifier.keras\n",
            "Saved: tokenizer_word_index.npy\n",
            "\n",
            "Demo predictions:\n",
            "  [High  ] (0.46) → Fraud detected on my account, please help immediately!\n",
            "  [Medium] (0.38) → My order was delayed by 3 days\n",
            "  [Low   ] (0.52) → Can you add a dark mode to the app?\n",
            "Saved → lstm_training_curves.png\n",
            "Saved → lstm_confusion_matrix.png\n",
            "Saved → lstm_roc_curves.png\n",
            "Saved → lstm_predicted_probs.png\n",
            "\n",
            "============================================================\n",
            "LSTM COMPLETE — files ready:\n",
            "  lstm_complaint_classifier.keras  — trained model\n",
            "  tokenizer_word_index.npy         — vocabulary\n",
            "  lstm_training_curves.png\n",
            "  lstm_confusion_matrix.png\n",
            "  lstm_roc_curves.png\n",
            "  lstm_predicted_probs.png\n",
            "\n",
            "Load the saved model later with:\n",
            "  from tensorflow.keras.models import load_model\n",
            "  model = load_model('lstm_complaint_classifier.keras')\n"
          ]
        }
      ]
    },
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "TbWLycFyqryw",
        "outputId": "37389300-ab0a-4919-88e1-e9a6dedb589a"
      },
      "execution_count": 15,
      "outputs": [
        {
          ...
          "text": [
            ...
            "\n",
            "SUMMARY TABLE:\n",
            "                    Type  Accuracy  Precision  Recall  F1-Score  ROC-AUC          CV F1\n",
            "Model                                                                                  \n",
            "Logistic Regression   ML    1.0000     1.0000  1.0000    1.0000   1.0000  0.5701±0.1354\n",
            "SVM                   ML    1.0000     1.0000  1.0000    1.0000   0.0833  0.5040±0.2259\n",
            "XGBoost               ML    0.5000     0.3333  0.5000    0.4000   0.8333  0.4471±0.0262\n",
            "RandomForest          ML    0.5000     0.4667  0.5000    0.4127   1.0000  0.3127±0.1473\n",
            "LSTM                  DL    0.3333     0.1111  0.3333    0.1667   0.6667            N/A\n",
            "\n",
            "Saved → evaluation_summary.csv\n",
            "Saved → eval_master_comparison.png\n",
            "Saved → eval_confusion_matrices.png\n",
            "Saved → eval_roc_all_models.png\n",
            "Saved → eval_per_class_f1.png\n",
            "Saved → eval_radar_chart.png\n",
            "Saved → eval_lstm_history.png\n",
            "Saved → eval_best_model_summary.png\n",
            "\n",
            "============================================================\n",
            "EVALUATION COMPLETE\n",
            "============================================================\n",
            "Best weighted F1     : Logistic Regression  (1.0000)\n",
            "Best ROC-AUC         : Logistic Regression  (1.0000)\n",
            "Best High-priority F1: Logistic Regression  (1.0000)\n",
            "\n",
            "Key insight: For a complaint triage system, prioritise\n",
            "  the model with the highest HIGH-PRIORITY F1 score,\n",
            "  since missing a critical complaint is more costly\n",
            "  than a false alarm.\n"
          ]
        }
      ]
